...
import 'package:mobile_banking/screen/WADashboardScreen.dart';
import 'package:mobile_banking/utils/WAColors.dart';
import 'package:mobile_banking/utils/WAWidgets.dart';

import '../model/cardDetailsModel.dart';

class PlatinumPlanSeletedDialog extends StatefulWidget {
  final CreditCardModel data;
  const PlatinumPlanSeletedDialog({
    Key? key,
    required this.data,
  ...
  @override
  PlatinumPlanSeletedDialogState createState() => PlatinumPlanSeletedDialogState(data: data);
}

class PlatinumPlanSeletedDialogState extends State<PlatinumPlanSeletedDialog> {
 PlatinumPlanSeletedDialogState({
    required this.data,
  }) : assert(data != null);
  final CreditCardModel data;
  @override
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        16.height,
        Text("You've Selected Platinum Plan", style: boldTextStyle(size: 22)),
        8.height,
        createRichText(list: [
